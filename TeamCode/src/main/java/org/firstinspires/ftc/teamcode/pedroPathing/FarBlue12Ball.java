...
//    private Servo tempServo = null;
    ...
    public void createPoses(){
        startPose = new Pose(144-87,8,Math.toRadians(180));

        pickup3[0] = new Pose(144-98,9,Math.toRadians(180));
        pickup3[1] = new Pose(144-136,9,Math.toRadians(180));

        pickup2[0] = new Pose(144-92,64,Math.toRadians(180));
        pickup2[1] = new Pose(144-134,64,Math.toRadians(180));

        pickup1[0] = new Pose(144-90 ,38,Math.toRadians(180));
        pickup1[1] = new Pose(144-134,38,Math.toRadians(180));

        shoot1 = new Pose(144-85,19,Math.toRadians(180));
